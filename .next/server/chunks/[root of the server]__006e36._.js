        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                if (manager && manager.password) {
                    const isPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, manager.password);
                    if (isPasswordValid) {
                        return {
                            id: manager.id,
                            name: manager.name,
                ...
                if (tenant && tenant.password) {
                    const isPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, tenant.password);
                    if (isPasswordValid) {
                        return {
                            id: tenant.id,
                            name: tenant.name,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__006e36._.js.map