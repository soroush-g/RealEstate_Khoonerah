...
async function Home() {
  ...
  return (
    <div className="w-screen min-h-screen py-20 flex flex-col items-center bg-[#030d11] text-white mb-4">
      {/* عنوان و هدر */}
      <HeaderSection />
      
      {/* بخش اضافه کردن تسک */}
      <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-lg w-[90%] md:w-[50%] lg:w-[40%] border border-white/20 mt">
        <AddTodo />
      </div>
