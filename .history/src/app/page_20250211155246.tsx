...
async function Home() {
  ...
  return (
    <div className="w-screen min-h-screen py-20 flex flex-col items-center bg-[#09322f] text-white">
      ...
      {/* Add Todo Section */}
      <div className="bg-[#09322f] p-6 rounded-xl shadow-xl w-[90%] md:w-[50%] lg:w-[40%]">
        <AddTodo />
      </div>
